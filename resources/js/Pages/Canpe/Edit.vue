    ...
    <LayoutMain>
        ...
        <CardBox class="mb-6" has-table>
            ...
            <form @submit.prevent="submit">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700">Contraseña (dejar en blanco para no
                        cambiar)</label>
                    <input type="password" v-model="form.password_canpe"
                        class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm" />
                </div>

                <div class="mb-4 flex items-center">
                    <input type="checkbox" v-model="form.inaccesible_canpe" class="mr-2" />
                    <label class="text-sm font-medium text-gray-700">¿Inaccesible?</label>
                </div>
